!******************************************************************************
module mod_read_ar_test  ! subrotines for reading .dat files                      !
!******************************************************************************
...
!******************************************************************************
  ...
  lineread=1
  do i=1,nline
    do j=lineread,sizeAR
      if (variabletmp(i,1) .eq. variableAR(j,1)) then
        variable(j,:)=variabletmp(i,:)
        lineread=j
        exit
      end if
     end do
