...
my_nice_caption=${FCST_DAY}${FCST_LEN}' - Contingency table for  '$descri' ('$unitof') processed with AR (1H) and thresholds (50,70) '$unitof
...
notice "Extracting skills and creating PODs table tablePODs${prefix}.texi and FIXED THRESHOLDS"
## PODs for BEF and AFT
#
# BEF
...
my_caption=${FCST_DAY}${FCST_LEN}' - PODs for '$descri' ('$unitof') and thresholds (50,70) '$unitof
