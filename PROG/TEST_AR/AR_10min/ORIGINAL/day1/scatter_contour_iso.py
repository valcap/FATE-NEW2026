...
#
#  Change minimum isoline to have a black line that corresponds to the righe envelop - look at the scattering plot with dots
#
levels = np.arange(0.01, np.max(Z), np.max(Z)/6.)
