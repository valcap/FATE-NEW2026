...
CALL HIT_RATE(WS_OBS_1D_FIT,WS_MOD_BEF_1D_FIT,NbFit,4.64,7.45,NOVAL,TAB_HR,POD,PC,EBD,.false.)
...
CALL HIT_RATE(WS_OBS_1D_FIT,WS_MOD_AFT_1D_FIT,NbFit,4.64,7.45,NOVAL,TAB_HR,POD,PC,EBD,.false.)
