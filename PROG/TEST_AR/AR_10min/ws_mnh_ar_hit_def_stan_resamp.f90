...
PRINT*,'INIT LETTURA ARGOMENTI IN ENTRATA'
READ(5,*) GG
PRINT*, 'GG=',GG
READ(5,*) HH
PRINT*, 'HH=',HH
...
PRINT*, 'CFILE_LIST_NIGHTS=',TRIM(CFILE_LIST_NIGHTS)
READ(5,*) PGPLOT1
PRINT*, 'PGPLOT1=',TRIM(PGPLOT1)
READ(5,*) PGPLOT2
PRINT*, 'PGPLOT2=',TRIM(PGPLOT2)
READ(5,*) FIX_THRES
PRINT*, 'FIX_THRES=',FIX_THRES
READ(5,*) IS_DAY
PRINT*, 'IS_DAY=',IS_DAY
PRINT*,'FINE LETTURA ARGOMENTI IN ENTRATA'
...
WRITE (*,1002) 'LOGINFO BIAS_WS_MOD_BEF=',BIAS_WS_MOD_BEF
WRITE (*,1002) 'LOGINFO RMSE_WS_MOD_BEF=',RMSE_WS_MOD_BEF
WRITE (*,1002) 'LOGINFO SIGMA_WS_MOD_BEF=',SIGMA_WS_MOD_BEF
...
WRITE (*,1002) 'LOGINFO BIAS_WS_MOD_AFT=',BIAS_WS_MOD_AFT
WRITE (*,1002) 'LOGINFO RMSE_WS_MOD_AFT=',RMSE_WS_MOD_AFT
WRITE (*,1002) 'LOGINFO SIGMA_WS_MOD_AFT=',SIGMA_WS_MOD_AFT
...
!write (*,1001) 'LOGINFO PERCENTILES XMED_WS=',XMED_WS
!write (*,1001) 'LOGINFO PERCENTILES X33_WS=',X33_WS
!write (*,1001) 'LOGINFO PERCENTILES X66_WS=',X66_WS
...
! START OF EDITS BY VALCAP74 @ 8-June-2024
IF ( FIX_THRES ) THEN
  X33_WS=12.0
  X66_WS=18.0
ELSE IF ( IS_DAY ) THEN
...
ELSE
  ...
  X66_WS=7.55
ENDIF
write (*,1001) 'LOGINFO BEF PERCENTILES X33_WS=',X33_WS
write (*,1001) 'LOGINFO BEF PERCENTILES X66_WS=',X66_WS
...
write (*,5000) 'LOGINFO CONTTABLE BEF ROW0 X<',X33_WS,X33_WS,'<X<',X66_WS,'X>',X66_WS
...
!CALL HIT_RATE(WS_OBS_1D_FIT,WS_MOD_BEF_1D_FIT,NbFit,X33_WS,X66_WS,NOVAL,TAB_HR,POD,PC,EBD,.false.)
!CALL HIT_RATE(WS_OBS_1D_FIT,WS_MOD_BEF_1D_FIT,NbFit,4.21,7.55,NOVAL,TAB_HR,POD,PC,EBD,.false.)
...
ELSE
  ...
  X66_WS=7.55
ENDIF
write (*,1001) 'LOGINFO AFT PERCENTILES X33_WS=',X33_WS
write (*,1001) 'LOGINFO AFT PERCENTILES X66_WS=',X66_WS
! END OF EDITS BY VALCAP74 @ 27-November-2023
...
write (*,5000) 'LOGINFO CONTTABLE AFT ROW0 X<',X33_WS,X33_WS,'<X<',X66_WS,'X>',X66_WS
...
!CALL HIT_RATE(WS_OBS_1D_FIT,WS_MOD_AFT_1D_FIT,NbFit,X33_WS,X66_WS,NOVAL,TAB_HR,POD,PC,EBD,.false.)
!CALL HIT_RATE(WS_OBS_1D_FIT,WS_MOD_AFT_1D_FIT,NbFit,4.21,7.55,NOVAL,TAB_HR,POD,PC,EBD,.false.)
! OUTPUT FORMATS
