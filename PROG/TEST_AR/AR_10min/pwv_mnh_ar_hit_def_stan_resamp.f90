...
!write (*,1001) 'LOGINFO PERCENTILES XMED_PWV=',XMED_PWV
!write (*,1001) 'LOGINFO PERCENTILES X33_PWV=',X33_PWV
!write (*,1001) 'LOGINFO PERCENTILES X66_PWV=',X66_PWV
PRINT*,'***************'
!
...
CALL HIT_RATE(PWV_OBS_1D_FIT,PWV_MOD_BEF_1D_FIT,NbFit,X33_PWV,X33_PWV,NOVAL,TAB_HR,POD,PC,EBD,.false.)
write (*,5000) 'LOGINFO CONTTABLE BEF ROW0 X<',X33_PWV,X33_PWV,'<X<',X66_PWV,'X>',X66_PWV
...
write (*,5000) 'LOGINFO CONTTABLE AFT ROW0 X<',X33_PWV,X33_PWV,'<X<',X66_PWV,'X>',X66_PWV
...
CALL PGLABEL('OBS: PWV (mm)','MNH: PWV (mm)','STANDARD CONFIGURATION')
DO I=1,NbNights
 DO J=1,NbLines_TOT
