...
WRITE (*,1002) 'LOGINFO BIAS_TAU_MOD_BEF=',BIAS_TAU_MOD_BEF
WRITE (*,1002) 'LOGINFO RMSE_TAU_MOD_BEF=',RMSE_TAU_MOD_BEF
WRITE (*,1002) 'LOGINFO SIGMA_TAU_MOD_BEF=',SIGMA_TAU_MOD_BEF
PRINT*,'INC_TAU_MOD_BEF=',INC_TAU_MOD_BEF
PRINT*,'LOGINFO BEF NbLines_TOT=',NbLines_TOT_1D
...
WRITE (*,1002) 'LOGINFO BIAS_TAU_MOD_AFT=',BIAS_TAU_MOD_AFT
WRITE (*,1002) 'LOGINFO RMSE_TAU_MOD_AFT=',RMSE_TAU_MOD_AFT
WRITE (*,1002) 'LOGINFO SIGMA_TAU_MOD_AFT=',SIGMA_TAU_MOD_AFT
