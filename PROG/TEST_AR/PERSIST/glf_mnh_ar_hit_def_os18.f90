...
WRITE (*,1002) 'LOGINFO BIAS_GLF_MOD_BEF=',BIAS_GLF_MOD_BEF
WRITE (*,1002) 'LOGINFO RMSE_GLF_MOD_BEF=',RMSE_GLF_MOD_BEF
WRITE (*,1002) 'LOGINFO SIGMA_GLF_MOD_BEF=',SIGMA_GLF_MOD_BEF
...
WRITE (*,1002) 'LOGINFO BIAS_GLF_MOD_AFT=',BIAS_GLF_MOD_AFT
WRITE (*,1002) 'LOGINFO RMSE_GLF_MOD_AFT=',RMSE_GLF_MOD_AFT
WRITE (*,1002) 'LOGINFO SIGMA_GLF_MOD_AFT=',SIGMA_GLF_MOD_AFT
...
write (*,1001) 'LOGINFO PERCENTILES XMED_GLF=',XMED_GLF
write (*,1001) 'LOGINFO PERCENTILES X33_GLF=',X33_GLF
write (*,1001) 'LOGINFO PERCENTILES X66_GLF=',X66_GLF
PRINT*,'***************'
!
