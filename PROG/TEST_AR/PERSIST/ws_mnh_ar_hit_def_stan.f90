...
write (*,1001) 'LOGINFO XMED_WS=',XMED_WS
write (*,1001) 'LOGINFO X33_WS=',X33_WS
write (*,1001) 'LOGINFO X66_WS=',X66_WS
PRINT*,'***************'
...
CALL PGLABEL('OBS: WS (m/s)','Persistence: WS (m/s)','CLASSIC')
DO I=1,NbNights
 DO J=1,NbLines_TOT
...
CALL PGSLW(3)  ! paper
CALL PGENV(xmin,xmax,xhmin,xhmax,1,0)
CALL PGLABEL('OBS: WS (m/s)','Persistence: WS (m/s)','WITH AR')
DO I=1,NbNights
 DO J=1,NbLines_TOT
